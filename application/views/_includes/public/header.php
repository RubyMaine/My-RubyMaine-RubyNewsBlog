        ...
        <header class="navbar navbar-expand-md navbar-light d-print-none">
            <div class="container-xl">
                ...
                <a href="<?= base_url(); ?>" class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pr-0 pr-md-3">
					<img src="<?= base_url(); ?>assets/dist/img/rubynewsblog.png" alt="Logo" class="brand-image" style="width: 400px;">
                </a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <a href="#" class="btn d-block btn-outline-primary">
										...
										<strong style="color: red;"><i class="fa fa-diamond" aria-hidden="true"></i> RubyNewsBlog v5.2.0 </strong>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <?php if (userdata()->role != "member") : ?>
                                    <a href="<?= base_url('dashboard'); ?>" class="dropdown-item"> Админ панель <span class="glyphicon glyphicon-align-left" aria-hidden="true"></span>  </a>
                                    <div class="dropdown-divider"></div>
                                <?php endif; ?>
                                <a href="<?= base_url('configuration/account') ?>" class="dropdown-item"> Мой Аккаунт </a>
                                <a href="<?= base_url('signout'); ?>" class="dropdown-item"> Выйти </a>
                            </div>
                        </div>
                    <?php else : ?>
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url('signin') ?>">
                                    ...
                                    <span class="nav-link-title"> Войти </span>
                                </a>
                            </li>
                        </ul>
                    <?php endif; ?>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url() ?>">
                                    ...
                                    <span class="nav-link-title"> Главный </span>
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <?php endforeach; ?>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="<?= base_url() ?>"> Показать все </a>
                                </div>
                            </li>
                        </ul>
