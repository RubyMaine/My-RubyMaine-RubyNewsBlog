    ...
    <div class="col-md-8 order-last order-md-first">
        <div class="card card-outline card-primary shadow-sm">
            <div class="card-header">
                <h3 class="card-title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Опубликовать контент: </h3>
            </div>
            <div class="card-body">
                <div class="form-group">
                    <label for="post_title"><i class="fa fa-pencil-square" aria-hidden="true"></i> Заголовок поста: </label>
                    <input id="post_title" name="post_title" class="form-control" type="text" placeholder="Заголовок поста..." value="<?= set_value('post_title'); ?>" autocomplete="off">
                    <?= form_error('post_title'); ?>
                </div>
                <label for="summernote"><i class="fa fa-list-alt" aria-hidden="true"></i> Описание поста: </label>
                <textarea id="summernote" class="form-control" rows="6" name="post_body" placeholder="Описание поста.."><?= set_value('post_body'); ?></textarea>
